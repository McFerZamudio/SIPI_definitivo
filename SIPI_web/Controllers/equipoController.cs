...
namespace SIPI_web.Controllers
{
    public class equipoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("id_equipo,equipo_nombre")] tbl_equipo tbl_equipo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id_equipo,equipo_nombre")] tbl_equipo tbl_equipo)
        {
